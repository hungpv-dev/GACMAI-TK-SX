...
@section('content')
    <div class="content">
        ...
        <h3 class="text-bold text-body-emphasis mb-5">Quản lý ngân hàng</h3>
        <div>
            <div class="mb-3 thongke">
                <div>
                    ...
                    <div class="body">
                        <p class="fw-bold m-0"><span class="thongke-sum" id="sum">0</span> ngân hàng</p>
            ...
            <div id="searchModel" class="d-none">
                <form class="d-flex align-items-center gap-3 flex-wrap mb-4" id="filter-form">
                    <div>
                        <input name="name" placeholder="Tìm kiếm ngân hàng" type="text" class="form-control value empty">
                    </div>
                    ...
                    <table class="table table-hover table-sm fs-9 mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="align-middle text-start text-uppercase">Mã định danh</th>
                                <th class="align-middle text-start text-uppercase">Tên viết tắt</th>
                                <th class="align-middle text-start text-uppercase">Tên đầy đủ</th>
            ...
            <div class="modal-dialog">
                <div class="modal-content form-open">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Thêm mới ngân hàng</h5>
                        ...
                        <form class="row g-3" method="POST">
                            <div class="col-sm-12 col-md-6">
                                <div class="form-floating">
                                    <input type="text" name="swift_code" class="form-control validate empty value"
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="form-floating">
                                    <input type="text" name="full_name" class="form-control validate empty value"
    ...
    <div class="modal fade" id="editModel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-dialog">
                <div class="modal-content form-open">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Cập nhật ngân hàng</h5>
                        <button class="btn p-1 closeButton" type="button" data-bs-dismiss="modal" aria-label="Close">
            ...
            return data.map((item) => {
                    return `
                        <tr class="${request.bold(item.id)}">
                            ...
                            <td class='align-middle text-start'>${item.swift_code}</td>
