    ...
    <div class="content">
        <nav class="mb-2" aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item">Loại tài khoản</li>
            </ol>
        </nav>
        <h3 class="text-bold text-body-emphasis mb-5">Quản lý loại tài khoản</h3>
        <div>
            ...
            <div id="searchModel" class="d-none">
                <form class="d-flex align-items-center gap-3 flex-wrap mb-4" id="filter-form">
                    <div>
                        <input name="name" placeholder="Tên loại tài khoản" type="text" class="form-control value empty">
                    </div>
                    ...
                    <table class="table table-hover table-sm fs-9 mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="align-middle text-start text-uppercase">Tên loại</th>
            ...
            <div class="modal-dialog">
                <div class="modal-content form-open">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Thêm mới loại tài khoản</h5>
...
@section('script')
    <script>
        const route = '/api/type-bank-account';
