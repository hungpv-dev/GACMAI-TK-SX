...
@section('content')
    <div class="content">
        ...
        <h3 class="text-bold text-body-emphasis mb-5">Danh sách sản phẩm</h3>
        <div>
            <div class="mb-3 thongke">
                <div>
                    ...
                    <div class="body">
                        <p class="fw-bold m-0"><span class="thongke-sum" id="sum">0</span> sản phẩm</p>
            ...
            <div id="searchModel" class="d-none">
                <form class="d-flex align-items-center gap-3 flex-wrap mb-4" id="filter-form">
                    <div>
                        <input name="name" placeholder="Tên sản phẩm" type="text" class="form-control value empty">
                    </div>
                    ...
                    <table class="table table-hover table-sm fs-9 mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="align-middle text-start text-uppercase">Tên sản phẩm</th>
                                <th class="align-middle text-start text-uppercase">Đơn vị tính</th>
                ...
                <div class="modal-content form-open">
                    ...
                    <div class="modal-body">
                        <form class="row g-3" method="POST">
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="form-floating">
                                    <select name="unit_id" title="Đơn vị tính" class="form-select choice value empty validate">
                                        <option value="">Chọn đơn vị tính</option>
                                        @foreach ($units as $item)
                                            <option value="{{ $item->id }}">{{ $item->name }}</option>
                                        @endforeach
                                    </select>
                                    <label class="floating-label-cus">Đơn vị tính</label>
                                </div>
                            </div>
            ...
            return data.map((item) => {
                    return `
                        <tr class="${request.bold(item.id)}">
                            ...
                            <td class='align-middle text-start'>${item.unit?.name}</td>
