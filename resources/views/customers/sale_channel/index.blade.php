    ...
    <div class="content">
        <nav class="mb-2" aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item">Kênh kinh doanh</li>
            </ol>
        </nav>
        <h3 class="text-bold text-body-emphasis mb-5">Danh sách kênh kinh doanh</h3>
        <div>
            <div class="mb-3 thongke">
                <div>
                    ...
                    <div class="body">
                        ...
                        <span class="fs-8 fw-bold text-body-highlight">Tổng số kênh</span>
                    </div>
                </div>
            </div>
            <!-- Search -->
            <div id="searchModel" class="d-none">
                <form class="d-flex align-items-center gap-3 flex-wrap mb-4" id="filter-form">
                    <div>
                        <input name="name" placeholder="Tên kênh" type="text" class="form-control value empty">
                    </div>
                    ...
                    <table class="table table-hover table-sm fs-9 mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="align-middle text-start text-uppercase">Tên kênh</th>
            ...
            <div class="modal-dialog">
                <div class="modal-content form-open">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Thêm mới kênh kinh doanh</h5>
    ...
    <div class="modal fade" id="editModel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-dialog">
                <div class="modal-content form-open">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Cập nhật kênh kinh doanh</h5>
                        <button class="btn p-1 closeButton" type="button" data-bs-dismiss="modal" aria-label="Close">
