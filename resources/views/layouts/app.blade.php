        ...
        <div class="collapse navbar-collapse navbar-top-collapse order-1 order-lg-0 justify-content-center"
            ...
            <ul class="navbar-nav navbar-nav-top" data-dropdown-on-hover="data-dropdown-on-hover">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle lh-1" href="/users">
                        <span class="uil fs-9 me-2 fas fa-users"></span>Quản lý nhân sự
                    </a>
                </li>
            </ul>
            <ul class="navbar-nav navbar-nav-top" data-dropdown-on-hover="data-dropdown-on-hover">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle lh-1" href="{{ route('customers.index') }}">
                        <span class="uil fs-9 me-2 fas fa-user-tie"></span>Quản lý khách hàng
                    </a>
                </li>
            </ul>
            <ul class="navbar-nav navbar-nav-top" data-dropdown-on-hover="data-dropdown-on-hover">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle lh-1" href="{{ route('orders.index') }}">
                        <span class="uil fs-9 me-2 fa fa-store"></span>Quản lý đơn hàng
                    </a>
                </li>
            </ul>
            <ul class="navbar-nav navbar-nav-top" data-dropdown-on-hover="data-dropdown-on-hover">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle lh-1" href="{{ route('debt.index') }}">
                        <span class="uil fs-9 me-2 far fa-money-bill-alt"></span>Quản lý công nợ
                    </a>
                </li>
            </ul>
            <ul class="navbar-nav navbar-nav-top" data-dropdown-on-hover="data-dropdown-on-hover">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle lh-1" href="{{ route('finance.index') }}">
                        <span class="uil fs-9 me-2 fas fa-university"></span>Tài chính
                    </a>
                </li>
            </ul>
        </div>
                    ...
                    <div class="card position-relative border-0">
                        <div class="card-header p-2">
                            <div class="d-flex justify-content-between">
                                <h5 class="text-body-emphasis mb-0">Khách hàng quá hạn</h5>
                            </div>
                        </div>
                        <div class="card-body p-0">
                            <div class="scrollbar-overlay">
                                @foreach ($dt as $item)
                                <a href='/customers/expired?status={{ $item->id }}{{ $item->id == status('customer_schelude') ? '&schedule=1' : '' }}'
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-1 me-sm-3">
                                                ...
                                                <p class="fs-9 text-body-highlight mb-2 mb-sm-3 fw-normal"><span
                                                        ...
                                                        class='fw-bold'>{{ $item->count_old }}</span> khách hàng đã
                                                    quá hạn
                                                </p>
                                            </div>
                                        </div>
                        ...
                        <div class="card-footer p-0 border-top border-translucent border-0">
                            <div class="my-2 text-center fw-bold fs-10 text-body-tertiary text-opactity-85"><a
                                    class="fw-bolder" href="#">Không có khách hàng nào</a></div>
                        </div>
                        @endempty
                    </div>
                </div>
                    ...
                    <div class="card position-relative border-0">
                        ...
                        <div class="overflow-auto scrollbar" style="height: 12rem;">
                            <ul class="nav d-flex flex-column mb-2 pb-1">
                                <li class="nav-item"><a class="nav-link px-3" href="/groups">
                                        <span class="me-2 text-body" data-feather="users"></span>
                                        <span>Quản lý nhóm nhân sự</span></a>
                                </li>
                                <li class="nav-item"><a class="nav-link px-3" href="/customer-notify">
                                        <span class="me-2 text-body" data-feather="bell"></span>
                                        <span>Quản lý thời gian thông báo</span></a>
                                </li>
                                <li class="nav-item"><a class="nav-link px-3" href="/categories">
                                        <span class="me-2 text-body" data-feather="box"></span>
                                        <span>Quản lý sản phẩm</span></a>
                                </li>
                                <li class="nav-item"><a class="nav-link px-3" href="/sale-channel">
                                        <span class="me-2 text-body" data-feather="moon"></span>
                                        <span>Quản lý kênh kinh doanh</span></a>
                                </li>
                                <li class="nav-item"><a class="nav-link px-3" href="/customers-status">
                                        <span class="me-2 text-body" data-feather="inbox"></span>
                                        <span>Quản lý trạng thái khách hàng</span></a>
                                </li>
                                <li class="nav-item"><a class="nav-link px-3" href="/orders-status">
                                        <span class="me-2 text-body" data-feather="shopping-bag"></span>
                                        <span>Quản lý trạng thái đơn hàng</span></a>
                                </li>
                                <li class="nav-item"><a class="nav-link px-3" href="/factory">
                                        <span class="me-2 text-body" data-feather="settings"></span>
                                        <span>Quản lý xưởng</span></a>
                                </li>
                                <li class="nav-item"><a class="nav-link px-3" href="/unit">
                                    <span class="me-2 text-body" data-feather="align-right"></span>
                                    <span>Đơn vị sản phẩm</span></a>
                                </li>
                            </ul>
                        </div>
