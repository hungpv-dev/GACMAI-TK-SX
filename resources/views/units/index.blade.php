...
@section('content')
    <div class="content">
        ...
        <h3 class="text-bold text-body-emphasis mb-5">Danh sách đơn vị</h3>
        <div>
            <div class="mb-3 thongke">
                <div>
                    ...
                    <div class="body">
                        <p class="fw-bold m-0"><span class="thongke-sum" id="sum">0</span> đơn vị</p>
                        <span class="fs-8 fw-bold text-body-highlight">Tổng số đơn vị</span>
                    </div>
                </div>
            </div>
            <!-- Search -->
            <div id="searchModel" class="d-none">
                <form class="d-flex align-items-center gap-3 flex-wrap mb-4" id="filter-form">
                    <div>
                        <input name="name" placeholder="Tên đơn vị" type="text" class="form-control value empty">
                    </div>
                    ...
                    <table class="table table-hover table-sm fs-9 mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="align-middle text-start text-uppercase">Tên đơn vị</th>
