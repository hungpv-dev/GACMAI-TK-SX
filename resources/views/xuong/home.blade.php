...
<div class="content">
    <div class="mb-5">
        <div class="alert alert-outline-warning d-flex align-items-center" role="alert">
            ...
            <p class="mb-0 flex-1">
                <a href="/orders?type_status=19" class="text-warning">
                    <span class='text-primary fw-bold'>Có <span class='text-danger fw-bold'>{{ status('count_start_xuong') }}</span> đơn mới!
                </a>
            </p>
    ...
    <div class="row-config my-5">
        <div
            ...
            <a href="/orders" data-type="2" class="">
                <p class="fs-9 mb-0">Đơn hàng sản xuất</p>
            </a>
        </div>
        <div
            class="col-6 col-md-4 mb-4 col-xxl-2 text-center border-translucent border-start-xxl border-end-xxl-0 border-bottom-xxl-0 border-end-md border-bottom pb-2 pt-2 pb-xxl-0" data-type="2">
            ...
            <a href="/orders/baohanh" data-type="2" class="">
                <p class="fs-9 mb-0">Đơn hàng bảo hành</p>
            </a>
        </div>
        <div
