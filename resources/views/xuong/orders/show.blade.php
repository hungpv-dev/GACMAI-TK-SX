    ...
    <div>
        ...
        <div class="mx-n4 mx-lg-n6 px-4 px-lg-6 mb-9 bg-body-emphasis border-y mt-2 position-relative top-1"
            ...
            <div class="typeTotalStatus mb-3">
                ...
                <div class='text-end fw-bold'>
                    <span class="total-order text-success fs-7 da-thu" id="total">{{ number_format($order->thuc_thu) }}
                        ₫</span>
                </div>
            </div>
            <p><span class='fw-bold'>Ghi chú: </span>{{ $order->updateLogLastest ? $order->updateLogLastest->note : 'Chưa có ghi chú' }}</p>
        </div>
                    ...
                    <form class="row g-3" method="POST" enctype="multipart/form-data">
                        <div class="col-sm-12 col-md-12">
                            <div class="input-group mb-3">
                                <input type="file" class="form-control value validate empty" name='file' id="hop_dong">
